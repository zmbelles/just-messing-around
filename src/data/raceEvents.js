...
export const GOOD_EVENTS = [
  ...
  {
    id: 'lucky-sponsor-gift',
    tier: 'good',
    title: 'Sponsor Bonus',
    description: 'Your sponsor just deposited a surprise bonus into your account after hearing about your strong recent performance.',
    sessionFilter: null,
    choices: null,
  ...
  },
  {
    ...
    tier: 'good',
    title: 'Lucky Draw',
    description: 'You didn\'t buy a ticket, but the track held a door prize drawing and your name was called. Free tires!',
    sessionFilter: null,
    choices: null,
    effects: [{ type: 'addTires' }],
  },
  {
    ...
    description: 'A veteran driver noticed your setup and offered some unsolicited advice. It was actually pretty helpful.',
    sessionFilter: null,
    choices: null,
    effects: [{ type: 'experience', amount: 1 }],
  },
]
...
export const BAD_EVENTS = [
  ...
  },
  {
    ...
    tier: 'bad',
    title: 'Bad Food',
    description: 'That gas station hot dog isn\'t sitting well with you. You spend most of the practice session in the bathroom.',
    sessionFilter: ['Practice 1', 'Practice 2', 'Practice Happy Hour', 'Practice Warm-up'],
    choices: null,
    effects: [{ type: 'experience', amount: -1 }],
  },
  {
    ...
    tier: 'bad',
    title: 'Lost Bet',
    description: 'You and your mechanic bet on the KA100 winner at the track. You were wrong. Better luck next time.',
    sessionFilter: null,
    choices: null,
  ...
  },
  {
    ...
    tier: 'bad',
    title: 'Tool Theft',
    description: 'You come back from practice and all your tools and spare bolts have been stolen from the pit area.',
    sessionFilter: null,
    choices: null,
    effects: [
      { type: 'consumable', key: 'nutsAndBolts', amount: -20 },
      { type: 'cash', amount: -500 },
    ],
  },
  {
    id: 'kart-stand-broken',
    tier: 'bad',
    title: 'Stand Failure',
    description: 'Your kart stand fails on the way to the track. Your kart tips over, damaging the bodywork.',
    sessionFilter: null,
    choices: null,
    effects: [
      { type: 'cash', amount: -100 },
      { type: 'consumable', key: 'bumperClips', amount: -2 },
    ],
  },
  {
    id: 'worse-setup',
    tier: 'bad',
    title: 'Setup Mistake',
    description: 'In your haste to get ready, you made a wrong adjustment to your kart. It handled terribly all session.',
    sessionFilter: null,
    choices: null,
    effects: [{ type: 'experience', amount: -1 }],
  },
