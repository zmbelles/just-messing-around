...
export default function KartEngineComponent({ gameState, onEquip }) {
  const { parts = {}, kart } = gameState
  const engineItems = STORE_ITEMS.filter(i => ['completeEngine','lawsonPrepEngine','dmitriEngine'].includes(i.partsKey))
  ...
  return (
    <div className={styles.card}>
      ...
      <SlotSection
        ...
        equipped={kart.equippedEngine}
        inventory={getInventoryItems(engineItems)}
